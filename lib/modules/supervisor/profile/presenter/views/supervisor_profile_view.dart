...
import 'package:doors/modules/common/authentication/infra/models/user_profile_data_model.dart';
...
class SupervisorProfileView extends StatefulWidget {
  ...
  @override
  State<SupervisorProfileView> createState() => _SupervisorProfileViewState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Consumer<ProfileProvider>(
          builder: (context,profileProvider,child) {
            final userData = profileProvider.userProfileData ??  UserProfileDataModel();
            return Column(
              ...
              children: [
                ...
                /// Name & Title
                CustomText(userData.name ?? "@User Name", textStyle:TextStyle(fontWeight: FontWeight.bold,fontSize: 18.sp)),
                SizedBox(height: 5.h),
